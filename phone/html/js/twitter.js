...
KR.Phone.Notifications.LoadTweets = function(Tweets) {
    ...
    if (Tweets !== null && Tweets !== undefined && Tweets !== "" && Tweets.length > 0) {
        ...
        $.each(Tweets, function(i, Tweet){
            ...
            var TwtMessage = KR.Phone.Functions.FormatTwitterMessage(clean);
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        KR.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Trebuie sa pui un mesaj", "#1DA1F2");
    };
    $('#tweet-new-url').val("");
...
function CopyMentionTag(elem) {
    ...
    KR.Phone.Notifications.Add("fab fa-twitter", "Twitter", $(elem).data('mentiontag')+ " copiat!", "rgb(27, 149, 224)", 1250);
