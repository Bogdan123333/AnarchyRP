...
AddEventHandler("clothes:firstSpawn", function()
    ...
    if IsModelInCdimage(model) and IsModelValid(model) then
        ...
        SetPedComponentVariation(GetPlayerPed(-1), 4, 4,0, 1)

        SetPedComponentVariation(GetPlayerPed(-1), 6, 76, 10, 0)
        SetPedComponentVariation(GetPlayerPed(-1), 2, 21, 0, 0)
        SetPedComponentVariation(GetPlayerPed(-1), 8, 134, 0, 0)
