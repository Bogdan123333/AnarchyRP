...
APPS.contacts = {
                ...
                appData.contactsList.append(`
                    ...
                    <div class="contact" data-number="${k}" data-name="${v.name}">
                        ...
                        <div class="actions">
                            ...
                            <div class="action tooltip" title="Call" data-act="call">
                                <i class="fa-solid fa-phone"></i>
                            </div>

                            <div class="action tooltip" title="Send message" data-act="message">
                                <i class="fas fa-message" aria-hidden="true"></i>
                            </div>

                            <div class="action tooltip" title="Edit Contact" data-act="edit">
                                <i class="fa-solid fa-pencil"></i>
                            </div>

                            <div class="action tooltip" title="Delete Contact" data-act="delete">
    ...
    async callNumber(number) {
        ...
        if (!response)
            return Notifications.show("You can't call yourself!");
        
        if (response.inCall)
            return Notifications.show("You're already in a call!");

        if (!response.available)
            return Notifications.show("The person is busy!");
