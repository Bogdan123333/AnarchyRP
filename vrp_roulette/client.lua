...
local coords = {-1748.5795898438,-759.18804931641,10.761982917786}
local open = false
local inMenu = true
...
local blip = vRP.addBlip({-1748.5795898438,-759.18804931641,10.761982917786,266,5,"Lucky Roulette"})
