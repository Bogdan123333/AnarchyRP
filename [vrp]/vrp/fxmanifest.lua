...
shared_scripts {
  "fivemopt/sh_mapmanager.lua"
}

client_scripts {
  "fivemopt/c_spawnmanager.lua",
  "fivemopt/c_mapmanager.lua",
  "fivemopt/c_sessionmanager.lua",
  "fivemopt/c_gamemode.lua",
}

server_scripts {
  "fivemopt/s_mapmanager.lua",
  "fivemopt/s_sessionmanager.lua",
  "fivemopt/s_gamemode.lua",
}
