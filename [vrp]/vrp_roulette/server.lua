...
spinMoneyRoulette = function(thePlayer,user_id)
	...
	if sansaBani == 30 and sansa == 100 then
		...
		Wait(10500)
		money2 = math.random(320000,330000)
	...
	elseif sansaDiamant == 15 and sansa == 100 then
		...
		actIPcoins = vRP.getdonationCoins({user_id})
		vRP.setdonationCoins({user_id,actIPcoins + coins})
		TriggerClientEvent('chatMessage',-1,"^6Roulette: ^1"..GetPlayerName(thePlayer).." ^0a castigat ^8"..coins.." ^0de IP Coins!")
	elseif sansaVip == 5 and sansa == 100 then
		...
		TriggerClientEvent('chatMessage',-1,"^6Roulette: ^1"..GetPlayerName(thePlayer).." ^0a castigat ^1Vip Diamond ^0pentru ^47 zile^0!")		
	...
	elseif sansaMasina == 2 and sansa == 100 then
		...
		exports.oxmysql:execute("INSERT IGNORE INTO vrp_user_vehicles(user_id,vehicle,vehicle_plate,veh_type) VALUES(@user_id,@vehicle,@vehicle_plate,@veh_type)",{["user_id"] = user_id, ["vehicle"] = "bmws", ["vehicle_plate"] = "B "..math.random(10000,99999), ["veh_type"] = "car"})
	elseif sansaMasina == 1 and sansa == 100 then
		...
		exports.oxmysql:execute("INSERT IGNORE INTO vrp_user_vehicles(user_id,vehicle,vehicle_plate,veh_type) VALUES(@user_id,@vehicle,@vehicle_plate,@veh_type)",{["user_id"] = user_id, ["vehicle"] = "lp700r", ["vehicle_plate"] = "B "..math.random(10000,99999), ["veh_type"] = "car"})
	elseif sansaDiamant == 10 and sansa == 100 then
		TriggerClientEvent('prizes:winSomething',thePlayer,"Diamant")
		Wait(10500)
		actIPcoins = vRP.getdonationCoins({user_id})
		vRP.setdonationCoins({user_id,actIPcoins + 10})
		TriggerClientEvent('chatMessage',-1,"^6Roulette: ^0Jucatorul ^1"..GetPlayerName(thePlayer).." ^0a castigat ^810 de IP Coins!")
	else
		TriggerClientEvent('prizes:winSomething',thePlayer,"baniputini")
		Wait(10500)
		money1 = math.random(100000,150000)
